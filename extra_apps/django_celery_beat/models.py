...
class SolarSchedule(models.Model):
    ...
    class Meta:
        ...
        verbose_name = 'solar 事件'
        verbose_name_plural = verbose_name  # _('solar events')
...
class IntervalSchedule(models.Model):
    ...
    class Meta:
        ...
        verbose_name = '时间间隔'  # _('interval')
        verbose_name_plural = verbose_name  # _('intervals')
...
class CrontabSchedule(models.Model):
    ...
    class Meta:
        ...
        verbose_name = 'Crontab时间表'  # _('crontab')
