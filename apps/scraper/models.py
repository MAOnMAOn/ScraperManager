...
#
#
# # class ScraperProject(models.Model):
# #     project = models.OneToOneField(Project, verbose_name='项目名称')
...
#
#     class Meta:
#         verbose_name = '爬虫实例数据(电商)'
#         verbose_name_plural = verbose_name
#
#     #  SpiderInstance.objects.aggregate(Count('title')) 统计 title的数目
