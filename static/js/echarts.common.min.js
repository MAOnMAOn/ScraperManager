!function (t, e) {
    ...
    function ce(t, e, n, i, r, o, a) {
        var s = be(t, {rich: o, truncate: a, font: e, textAlign: n, textPadding: r}), l = s.outerWidth,
            h = s.outerHeight;
    ...
    function ke(t, e, n, i, r) {
        ...
        var l = s.outerHeight, h = s.lines, u = s.lineHeight, c = Be(l, i, r), d = c.baseX, f = c.baseY,
    ...
    function Pe(t, e, n, i, r) {
        var o = n.width, a = n.outerWidth, s = n.outerHeight, l = i.textPadding, h = Be(s, i, r), u = h.baseX,
    ...
    function or(t, e, n, i, r, o, a) {
        var s = (r = r || nv).labelFetcher, l = r.labelDataIndex, h = r.labelDimIndex, u = n.getShallow("show"),
            ...
            f = u ? d : null, p = c ? T(s ? s.getFormattedLabel(l, "emphasis", null, h) : null, d) : null;
    ...
    function da(t, e, n) {
        ...
        var i = e.get("coordinateSystem"), r = Zm[i], o = to.get(i),
            a = {encodeDef: e.get("encode"), dimsDef: e.get("dimensions")}, s = r && r(t, e, n, a),
            h = s && s.dimensions;
    ...
    function ns(t, e, n) {
        var i = Ja(t.getAxis("x")), r = Ja(t.getAxis("y")), o = t.getBaseAxis().isHorizontal(),
            a = Math.min(i[0], i[1]), s = Math.min(r[0], r[1]), l = Math.max(i[0], i[1]) - a,
            h = Math.max(r[0], r[1]) - s, u = n.get("lineStyle.normal.width") || 2,
        ...
        ux(n.getCoordinateSystems(), function (n) {
            function s(i, s, l) {
                ...
                if (d && ("auto" !== d || i || Bs(c))) {
                    ...
                    var f = (c = i ? Ds(l, u, r, e, i, s) : c).get("snap"), p = Rs(l.model),
    ...
    function Xs(t, e, n) {
        ...
        e.eachSeriesByType(t, function (t) {
            if ("cartesian2d" === t.coordinateSystem.type) {
                var e = t.getData(), n = t.coordinateSystem, a = n.getBaseAxis(), s = Hs(t), l = i[Fs(a)][s],
    ...
    var _d = 2311, wd = function () {
        ...
        }, Td = Object.prototype.toString, Ad = Array.prototype, Cd = Ad.forEach, kd = Ad.filter, Dd = Ad.slice,
        Pd = Ad.map, Ld = Ad.reduce, Od = {}, zd = function () {
    ...
    var Bf = "undefined" != typeof window && (window.requestAnimationFrame && window.requestAnimationFrame.bind(window) || window.msRequestAnimationFrame && window.msRequestAnimationFrame.bind(window) || window.mozRequestAnimationFrame || window.webkitRequestAnimationFrame) || function (t) {
            setTimeout(t, 16)
        }, Rf = new sf(50), Vf = {}, Wf = 0, Gf = 5e3, Hf = /\{([a-zA-Z0-9_]+)\|([^}]*)\}/g, Ff = "12px sans-serif",
        Zf = {};
    ...
    var ip = {
        ...
        ap = {pointerdown: 1, pointerup: 1, pointermove: 1, pointerout: 1}, sp = f(rp, function (t) {
    ...
    var pp = (Object.freeze || Object)({
        ...
        Hp = Math.min, Fp = Math.max, Zp = Math.sin, Up = Math.cos, Xp = 2 * Math.PI, jp = N(), qp = N(), Yp = N(),
        $p = [], Kp = [], Qp = {M: 1, L: 2, C: 3, Q: 4, A: 5, Z: 6, R: 7}, Jp = [], tg = [], eg = [], ng = [],
        ig = Math.min, rg = Math.max, og = Math.cos, ag = Math.sin, sg = Math.sqrt, lg = Math.abs,
        hg = "undefined" != typeof Float32Array, ug = function (t) {
    ...
    ug.prototype = {
        ...
        _dashedLineTo: function (t, e) {
            var n, i, r = this._dashSum, o = this._dashOffset, a = this._lineDash, s = this._ctx, l = this._xi,
                h = this._yi, u = t - l, c = e - h, d = sg(u * u + c * c), f = l, p = h, g = a.length;
                ...
                switch (1 == c && (e = i = s[c], n = r = s[c + 1]), d) {
                    ...
                    case Qp.A:
                        var f = s[c++], p = s[c++], g = s[c++], v = s[c++], m = s[c++], y = s[c++], x = s[c++],
                            _ = s[c++], w = g > v ? g : v, b = g > v ? 1 : g / v, M = g > v ? v / g : 1, S = m + y;
    ...
    Bm.type = "list", Bm.hasItemOption = !0, Bm.getDimension = function (t) {
        ...
        var i, r = this._storage = {}, o = this.indices = [], a = this.dimensions, s = this._dimensionInfos,
            l = t.count(), h = [], u = {};
        e = e || [];
    ...
    var Vm = d, Wm = _, Gm = a, Hm = {tooltip: 1, label: 1, itemName: 1}, Fm = la.guessOrdinal = function (t, e) {
        ...
        cartesian2d: function (t, e, n, i) {
            ...
            var r = n.queryComponents({mainType: "polar", index: e.get("polarIndex"), id: e.get("polarId")})[0],
                o = r.findAxisModel("angleAxis"), a = r.findAxisModel("radiusAxis"), s = a.get("type"),
                l = o.get("type"),
    ...
    var Py = function (t, e, n, i, r, o) {
        ...
        buildPath: function (t, e) {
            var n = e.points, i = e.stackedOnPoints, r = 0, o = n.length, a = e.smoothMonotone,
                s = $a(n, e.smoothConstraint), l = $a(i, e.smoothConstraint);
            if (e.connectNulls) {
                for (; o > 0 && qa(n[o - 1]); o--) ;
                for (; r < o && qa(n[r]); r++) ;
            }
    ...
    mo.extend({
        type: "line", init: function () {
            ...
            var o = this._polyline, a = this._polygon, s = t.hostModel,
                l = Py(this._data, t, this._stackedOnPoints, e, this._coordSys, n), h = l.current,
            ...
            type: "cartesianAxis", axisPointerClass: "CartesianAxisPointer", render: function (t, e, n, i) {
                ...
                if (!i.scale.isBlank()) {
                    var r = t.getModel("splitArea"), o = r.getModel("areaStyle"), s = o.get("color"),
                        ...
                        c = i.toGlobalCoord(h[0]), d = i.toGlobalCoord(h[0]), f = 0, p = gx(r, n), g = o.getAreaStyle();
                    s = y(s) ? s : [s];
        ...
        type: "pie", init: function () {
            ...
            if (!i || i.from !== this.uid) {
                var r = t.getData(), o = this._data, a = this.group, s = e.get("animation"), l = !o,
                    h = t.get("animationType"), u = m(Js, this.uid, t, s, n), c = t.get("selectedMode");
        ...
        type: "legend.plain", newlineDisabled: !1, init: function () {
            ...
            if (this.resetInner(), t.get("show", !0)) {
                ...
                var r = t.getBoxLayoutParams(), o = {width: n.getWidth(), height: n.getHeight()}, s = t.get("padding"),
                    l = Hr(r, o, s), h = this.layoutInner(t, i, l),
            ...
            var u = i.get("itemWidth"), c = i.get("itemHeight"), d = i.get("inactiveColor"), f = i.isSelected(t),
                p = new n_, g = n.getModel("textStyle"), v = n.get("icon"), m = n.getModel("tooltip"),
                y = m.parentModel;
    ...
    var r_ = Jx.extend({
        ...
        type: "legend.scroll", newlineDisabled: !0, init: function () {
            ...
            var i = this.getContentGroup(), r = this._containerGroup, o = this._controllerGroup,
                a = t.getOrient().index, s = a_[a], l = a_[1 - a], h = s_[1 - a];
    ...
    g_.extend({
        type: "markPoint", updateLayout: function (t, e, n) {
            ...
            var r = t.coordinateSystem, o = t.id, a = t.getData(), s = this.markerGroupMap,
                l = s.get(o) || s.set(o, new Fa), h = _h(r, t, e);
    ...
    Qo({
        type: "toolbox", render: function (t, e, n, i) {
            ...
            function o(i, r, o) {
                var l = i.getModel("iconStyle"), h = r.getIcons ? r.getIcons() : i.get("icon"),
                    u = i.get("title") || {};
                if ("string" == typeof h) {
                    var c = h, f = u;
                    u = {}, (h = {})[o] = c, u[o] = f
    ...
    var Pw = {
        ...
        lineX: Aw(kc, 0), lineY: Aw(kc, 1), rect: function (t, e, n) {
            var i = e[Cw[t]]([n[0][0], n[1][0]]), r = e[Cw[t]]([n[0][1], n[1][1]]),
